...
export interface Job { id: string; query: string; platforms: string[]; analysis_mode: AnalysisMode; status: JobStatus; progress: number; clarification_round: number; execution_version: number; revision_of_job_id?: string | null; topic_spec?: Record<string, unknown> | null; interaction_usage?: Record<string, unknown>; error_code?: string | null; error_message?: string | null; report_id?: string | null; created_at: string; started_at?: string | null; completed_at?: string | null; events?: JobEvent[]; }
