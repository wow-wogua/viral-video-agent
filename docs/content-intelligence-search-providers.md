...
该请求未传 `include_competitors`，因此继续保持纯 P0-B 行为。P0-C 必须显式传 `include_competitors=true`，并使用独立 Creator Provider 与 `/jobs/{job_id}/competitors`；详见 [P0-C Creator Provider、竞品相关性与 Top 5](content-intelligence-competitor-scoring.md)。
